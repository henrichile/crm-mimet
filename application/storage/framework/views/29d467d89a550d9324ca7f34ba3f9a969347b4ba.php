        ...
        <table id="custom-fields" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10"">
            <thead>
                <tr>
                    ...
                    <th class=" w-15"><?php echo e(cleanLang(__('lang.show_lead'))); ?></th>
            ...
            <tbody id="status-td-container">
                ...
                <tr>
                    ...
                    <td class="td-checkbox">
                        ...
                        <label for="customfields_show_lead_summary[<?php echo e($field->customfields_id); ?>]"></label>
                    </td>
                    <!--required-->
                    <td class="td-checkbox">
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mimet.etasoft.cl/public_html/application/resources/views/pages/settings/sections/customfields/leads.blade.php ENDPATH**/ ?>