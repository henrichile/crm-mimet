  ...
  <!--custom form fields-->
    <div class="x-section">
     ...
     <div class="x-section">
        ...
        <a class="x-element" style="padding: 10px 35px 17px 20px;" href="https://portal.autoescuelahuelen.cl/matricular.php?idlead=<?php echo e($lead->lead_id); ?>" target="_new"><i
                class="mdi mdi-redo-variant"></i>
            <span class="x-highlight">Matricular en SAEC</strong></span>
        </a>
        <?php endif; ?>
     </div>
    ...
    </div><?php /**PATH /home/crmhuelen/public_html/application/resources/views/pages/lead/rightpanel.blade.php ENDPATH**/ ?>