            ...
            <li class="nav-item dropdown <?php echo e($page['tabmenu_more'] ?? ''); ?>">
                ...
                <div class="dropdown-menu" x-placement="bottom-start" id="fx-topnav-dropdown">
                    ...
                    <a class="dropdown-item   js-dynamic-url js-ajax-ux-request <?php echo e($page['tabmenu_estimates'] ?? ''); ?>"
                        data-toggle="tab" data-loading-class="loading-tabs"
                        data-loading-target="embed-content-container"
                        data-dynamic-url="<?php echo e(url('/projects')); ?>/<?php echo e($project->project_id); ?>/estimates"
...
</div><?php /**PATH /home/crmhuelen/public_html/application/resources/views/pages/project/components/misc/topnav.blade.php ENDPATH**/ ?>