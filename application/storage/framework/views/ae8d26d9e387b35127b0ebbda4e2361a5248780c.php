    ...
    <div id="list-page-actions">
        ...
        <div class="header-search" id="header-search">
            ...
            <input type="text" class="form-control search-records list-actions-search"
                ...
                data-form-id="header-search" id="search_user" name="search_user"
                placeholder="Buscar por nombre" style="width:250px !important;">
        </div>
        -->
        <div class="header-search" id="header-search">
            <i class="sl-icon-magnifier"></i>
        ...
        <div class="btn-group" id="search_mes">
            <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                class="list-actions-button btn waves-effect waves-dark dropdown-toggle">Meses</i></button>
            <div class="dropdown-menu dropdown-menu-right fx-kaban-sorting-dropdown">
                <div class="fx-kaban-sorting-dropdown-container">Meses por ver</div>
                <a class="dropdown-item js-ajax-ux-request" id="search_mes_1" href="javascript:void(0)"
                    data-url="https://crm.autoescuelahuelen.cl/leads/search?action=search&leadresource_id=&leadresource_type=&dias=30">1 Mes</a>
                <a class="dropdown-item js-ajax-ux-request" id="search_mes_2" href="javascript:void(0)"
                    data-url="https://crm.autoescuelahuelen.cl/leads/search?action=search&leadresource_id=&leadresource_type=&dias=60">2 Meses</a>
                <a class="dropdown-item js-ajax-ux-request" id="search_mes_3" href="javascript:void(0)"
                    data-url="https://crm.autoescuelahuelen.cl/leads/search?action=search&leadresource_id=&leadresource_type=&dias=90">3 Meses</a>
                <a class="dropdown-item js-ajax-ux-request" id="search_mes_4" href="javascript:void(0)"
                    data-url="https://crm.autoescuelahuelen.cl/leads/search?action=search&leadresource_id=&leadresource_type=&dias=120">4 Meses</a>
                <a class="dropdown-item js-ajax-ux-request" id="search_mes_5" href="javascript:void(0)"
                    data-url="https://crm.autoescuelahuelen.cl/leads/search?action=search&leadresource_id=&leadresource_type=&dias=150">5 Meses</a>
                <a class="dropdown-item js-ajax-ux-request" id="search_mes_6" href="javascript:void(0)"
                    data-url="https://crm.autoescuelahuelen.cl/leads/search?action=search&leadresource_id=&leadresource_type=&dias=180">6 Meses</a>
                <a class="dropdown-item js-ajax-ux-request" id="search_mes_6" href="javascript:void(0)"
                    data-url="https://crm.autoescuelahuelen.cl/leads/search?action=search&leadresource_id=&leadresource_type=&dias=356">1 Año</a>
            </div>
        </div>
...
</div><?php /**PATH /home/mimet.etasoft.cl/public_html/application/resources/views/pages/leads/components/misc/list-page-actions.blade.php ENDPATH**/ ?>