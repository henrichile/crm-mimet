...
<div id="card-title-edit" class="card-title-edit hidden">
  	<select class="form-control select2" id="lead_title" name="lead_title" data-placeholder="Seleccione" required >						  
           <option value="Cotizador" 				<?php if(strtolower($lead->lead_title)=='Cotizador'): ?> selected="selected" <?php endif; ?> 	>Cotizador</option>
           <option value="Mundo Repuestos" 			<?php if(strtolower($lead->lead_title)=='Mundo Repuestos'): ?> selected="selected" <?php endif; ?> 	>Mundo Repuestos</option>
           <option value="Formulario de contacto" 	<?php if(strtolower($lead->lead_title)=='Formulario de contacto'): ?> selected="selected" <?php endif; ?> >Formulario de contacto</option>
    </select> 
...
<?php endif; ?><?php /**PATH /home/mimet.etasoft.cl/public_html/application/resources/views/pages/lead/components/title.blade.php ENDPATH**/ ?>