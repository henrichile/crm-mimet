        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
              	<select class="form-control select2" id="lead_title" name="lead_title" data-placeholder="Seleccione" required >			
                 	  <option value="" 						@if(isset($lead))@if(strtolower($lead->lead_title)=='') selected="selected" @endif @endif	>Seleccione</option>
                      <option value="Google" 				@if(isset($lead))@if(strtolower($lead->lead_title)=='google') selected="selected" @endif @endif	>Google</option>
                      <option value="Facebook" 				@if(isset($lead))@if(strtolower($lead->lead_title)=='facebook') selected="selected" @endif @endif	>Facebook</option>
                      <option value="Instagram" 			@if(isset($lead))@if(strtolower($lead->lead_title)=='instagram') selected="selected" @endif @endif>Instagram</option>
                      <option value="Correo" 				@if(isset($lead))@if(strtolower($lead->lead_title)=='correo') selected="selected" @endif @endif >Correo</option>
                      <option value="Whatsapp Ventas" 		@if(isset($lead))@if(strtolower($lead->lead_title)=='whatsapp ventas') selected="selected" @endif @endif >Whatsapp Ventas</option>
                      <option value="Whatsapp Santa Lucia" 	@if(isset($lead))@if(strtolower($lead->lead_title)=='whatsapp santa lucia') selected="selected" @endif @endif >Whatsapp Santa Lucia</option>
                      <option value="Whatsapp La Cisterna" 	@if(isset($lead))@if(strtolower($lead->lead_title)=='whatsapp la cisterna') selected="selected" @endif @endif >Whatsapp La Cisterna</option>   
                      <option value="Whatsapp Vitacura" 	@if(isset($lead))@if(strtolower($lead->lead_title)=='whatsapp santa lucia') selected="selected" @endif @endif >Whatsapp Vitacura</option>
                      <option value="Whatsapp La Reina" 	@if(isset($lead))@if(strtolower($lead->lead_title)=='whatsapp la reina') selected="selected" @endif @endif >Whatsapp La Reina</option>
                      <option value="Llamado Ventas" 		@if(isset($lead))@if(strtolower($lead->lead_title)=='llamado ventas') selected="selected" @endif @endif >Llamado Ventas</option>
                      <option value="Llamado Santa Lucia" 	@if(isset($lead))@if(strtolower($lead->lead_title)=='llamado santa lucia') selected="selected" @endif @endif >Llamado Santa Lucia</option>
                      <option value="Llamado La Cisterna" 	@if(isset($lead))@if(strtolower($lead->lead_title)=='llamado la cisterna') selected="selected" @endif @endif >Llamado La Cisterna</option>   
                      <option value="Llamado Vitacura" 		@if(isset($lead))@if(strtolower($lead->lead_title)=='llamado santa lucia') selected="selected" @endif @endif >Llamado Vitacura</option>
                      <option value="Llamado La Reina" 		@if(isset($lead))@if(strtolower($lead->lead_title)=='llamado la reina') selected="selected" @endif @endif >Llamado La Reina</option>
                      <option value="Sucursal Santa Lucia" 	@if(isset($lead))@if(strtolower($lead->lead_title)=='sucursal santa lucia') selected="selected" @endif @endif >Sucursal Santa Lucia</option>
                      <option value="Sucursal La Cisterna" 	@if(isset($lead))@if(strtolower($lead->lead_title)=='sucursal la cisterna') selected="selected" @endif @endif >Sucursal La Cisterna</option>   
                      <option value="Sucursal Vitacura" 	@if(isset($lead))@if(strtolower($lead->lead_title)=='sucursal santa lucia') selected="selected" @endif @endif >Sucursal Vitacura</option>
                      <option value="Sucursal La Reina" 	@if(isset($lead))@if(strtolower($lead->lead_title)=='sucursal la reina') selected="selected" @endif @endif >Sucursal La Reina</option>
              	 </select> 
            </div>
        </div>
        <!--first name-->
