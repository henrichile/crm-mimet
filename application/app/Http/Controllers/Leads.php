...
class Leads extends Controller {
    ...
    public function updateCustomFields($id) {
        ...
        if (request()->filled('lead_custom_field_11')) {
            $lead->lead_custom_field_11 = request('lead_custom_field_11');
        }
        if (request()->filled('lead_custom_field_12')) {
            $lead->lead_custom_field_12 = request('lead_custom_field_12');
        }
